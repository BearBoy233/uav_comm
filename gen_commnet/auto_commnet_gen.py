...
'''
To be Tested Later
Parses the custom MAVLink protocol XML file and automatically generates the corresponding C++ program

# Final instructions
# file | commnet
# python3 -m auto_commnet_gen ../gen_mavlinkHPP/message_definitions/v1.0/commnet.xml
# file | xml_test
# python3 -m auto_commnet_gen --output=generated xml.xml

# python3 -m pymavlink.tools.mavgen --lang=C --wire-protocol=2.0 --output=generated/include/mavlink/v2.0 commnet.xml
...
parser.add_argument("--wire-protocol", choices=[mavparse.PROTOCOL_1_0, mavparse.PROTOCOL_2_0], default=mavgen.DEFAULT_WIRE_PROTOCOL, help="MAVLink protocol version. [default: %(default)s]")
