...
#define MAVLINK_MSG_ID_GLOBAL_POSITION_INT 1002
...
#define MAVLINK_MSG_ID_GLOBAL_POSITION_INT_LEN 14
#define MAVLINK_MSG_ID_GLOBAL_POSITION_INT_MIN_LEN 14
#define MAVLINK_MSG_ID_1002_LEN 14
#define MAVLINK_MSG_ID_1002_MIN_LEN 14

#define MAVLINK_MSG_ID_GLOBAL_POSITION_INT_CRC 170
#define MAVLINK_MSG_ID_1002_CRC 170
...
#define MAVLINK_MESSAGE_INFO_GLOBAL_POSITION_INT { \
    ...
    {  { "lat", NULL, MAVLINK_TYPE_INT32_T, 0, 0, offsetof(mavlink_global_position_int_t, lat) }, \
         ...
         { "hdg_yaw", NULL, MAVLINK_TYPE_UINT16_T, 0, 12, offsetof(mavlink_global_position_int_t, hdg_yaw) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_GLOBAL_POSITION_INT { \
...
{
    return mavlink_msg_global_position_int_pack(system_id, component_id, msg, global_position_int->lat, global_position_int->lon, global_position_int->alt, global_position_int->hdg_yaw);
}
...
{
    return mavlink_msg_global_position_int_pack_chan(system_id, component_id, chan, msg, global_position_int->lat, global_position_int->lon, global_position_int->alt, global_position_int->hdg_yaw);
}
...
static inline void mavlink_msg_global_position_int_send(mavlink_channel_t chan, int32_t lat, int32_t lon, int32_t alt, uint16_t hdg_yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_GLOBAL_POSITION_INT_LEN];
    _mav_put_int32_t(buf, 0, lat);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_global_position_int_send(chan, global_position_int->lat, global_position_int->lon, global_position_int->alt, global_position_int->hdg_yaw);
#else
 ...
 */
static inline void mavlink_msg_global_position_int_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  int32_t lat, int32_t lon, int32_t alt, uint16_t hdg_yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field hdg_yaw from global_position_int message
 *
 * @return  cdeg, Vehicle heading(yaw angle), 0.0..359.99 degrees.
 */
static inline uint16_t mavlink_msg_global_position_int_get_hdg_yaw(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_global_position_int_decode(const mavlink_message_t* msg, mavlink_global_position_int_t* global_position_int)
{
    ...
    global_position_int->hdg_yaw = mavlink_msg_global_position_int_get_hdg_yaw(msg);
#else
