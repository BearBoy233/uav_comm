...
class MavrosOffboardPosctlTest(MavrosTestCommon):
    """
    Tests flying a path in offboard control by sending position setpoints via MAVROS.
    ...
    def setUp(self):
        ...
        self.pos_setpoint_pub = rospy.Publisher(
            '/car1/mavros/setpoint_position/local', PoseStamped, queue_size=1)
    ...
    def test_posctl(self):
        ...
        # 
        # Design trajectory
        # ? A time constraint NEED TO BE removed ?
        #
